...
<template>
  <div class="flex h-full w-full flex-col lg:flex-row font-sans transition-colors duration-200">
    <aside
      class="w-full lg:w-72 flex-shrink-0 overflow-y-auto border-b lg:border-b-0 lg:border-r border-slate-200/60 bg-white/80 p-4 shadow-lg backdrop-blur-xl dark:border-white/5 dark:bg-[#0a0f1e]/80"
    >

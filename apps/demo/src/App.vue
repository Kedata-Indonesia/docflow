...
const LETTER_DOC = {
  type: 'doc',
  content: [
    { type: 'heading', attrs: { level: 1 }, content: [{ type: 'text', text: 'Official Letter' }] },
    { type: 'paragraph', content: [{ type: 'text', text: 'Date: ____________' }] },
    { type: 'paragraph', content: [{ type: 'text', text: 'To:' }] },
    { type: 'paragraph', content: [{ type: 'text', text: 'Subject: ____________' }] },
    { type: 'paragraph' },
    { type: 'paragraph', content: [{ type: 'text', text: 'Dear Sir/Madam,' }] },
    { type: 'paragraph', content: [{ type: 'text', text: 'Write your letter content here.' }] },
    { type: 'paragraph' },

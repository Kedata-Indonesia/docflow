export default {
  ...
  editor: {
    ...
    headerFooter: {
      ...
      alignPlacement: 'Content placement',
      alignLeft: 'Align left',
      alignCenter: 'Align center',
      alignRight: 'Align right',
      placementSection: 'Placement',
      placementHint: 'Header/footer content is aligned within the text area (left/center/right).',
      ...
      hideOnPages: 'Hide page numbers on',
      hideOnPagesPlaceholder: 'e.g. 1, 3-5',
      hideOnPagesHint: 'Separate with commas; use a dash for ranges (e.g. 1, 3-5). Pages are still counted, only the number is hidden.',
      apply: 'Apply',
      cancel: 'Cancel',
      save: 'Save',
    },
